...
// Gère l'authentification par empreinte digitale et Face ID
...
class BiometricAuthService {
  ...
  // Initialiser le service avec gestion des plateformes non supportées
  Future<void> initialize() async {
    try {
      // Sur web, la biométrie n'est pas supportée
      if (kIsWeb) {
  ...
  Future<bool> get isAvailable async {
    try {
      // Retourner false sur web immédiatement
